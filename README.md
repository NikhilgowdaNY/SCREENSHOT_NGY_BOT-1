# [SCREENSHOT_NGY_BOT](https://tx.me/SCREENSHOT_NGY_BOT)
> Telegram Bot For Screenshot Generation.

## Description

An attempt to implement the screenshot generation of telegram files without downloading the entire file. Live version can be found here [SCREENSHOT_NGY_BOT](https://tx.me/SCREENSHOT_NGY_BOT "Screenshot Generator Bot").
...
```
$ git clone https://github.com/NikhilNGY/SCREENSHOT_NGY_BOT
$ cd animated-lamp
````
...
## Contact
You can contact me [@NGY_BOT](https://tx.me/NGY_BOT).
